...
public abstract class AnvilMenuModify extends ItemCombinerMenu {
    private AnvilMenuModify(@Nullable MenuType<?> p_39773_, int p_39774_, Inventory p_39775_, ContainerLevelAccess p_39776_) {
